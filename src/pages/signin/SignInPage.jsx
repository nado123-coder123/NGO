        ...
        <div className="bg-white dark:bg-slate-800 rounded-[2rem] shadow-xl shadow-slate-200/50 dark:shadow-slate-950/50 border border-slate-100 dark:border-slate-700 p-10 relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            <div className="relative w-16 h-16 overflow-hidden bg-violet-100 dark:bg-violet-900/50 rounded-full mx-auto mb-4 ring-4 ring-violet-50 dark:ring-violet-900/30">
              <svg className="absolute w-[72px] h-[72px] text-violet-400 -left-1" fill="currentColor" viewBox="0 0 20 20">
          ...
          <form className="space-y-6">
            <div>
              ...
              <input
                ...
                name="username"
                required
                className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-800 dark:text-white focus:ring-2 focus:ring-violet-400 focus:outline-none transition"
              />
            </div>
            ...
            <div className="flex justify-between items-center text-sm font-medium">
              <div className="flex items-center">
                <input
                  id="remember"
                  type="checkbox"
                  className="w-4 h-4 text-violet-600 bg-gray-100 dark:bg-slate-700 border-gray-300 dark:border-slate-600 rounded focus:ring-violet-500 focus:ring-2"
                />
                <label htmlFor="remember" className="ms-2 text-sm font-medium text-slate-600 dark:text-slate-400">
                  Remember me
                </label>
              </div>
              <a href="#" className="text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300 hover:underline transition-colors">
                Forgot Password?
              </a>
            </div>
            ...
            <button
              type="submit"
              className="w-full text-white bg-violet-600 hover:bg-violet-700 focus:ring-4 focus:ring-violet-300 dark:focus:ring-violet-800 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none transition-all"
            >
              Secure Log In
            </button>
          </form>
